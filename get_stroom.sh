...
# bash <(cat ~/git_work/stroom-resources/bin/stack/lib/get_stroom.sh | sed 's/stroom_core_test/stroom_core_test/; s/stroom-stacks-v6.1-beta.8/stroom-stacks-v6.0-beta.28-9/; s/v6.1-beta.8/v6.0-beta.28-9/; s/2c0fd2d4da61b640ca2f0abb9e1085830370e7380546c1b1afc4933a63c931fb  stroom_core_test-v6.1-beta.8.tar.gz/fc593474e2ee6b9a7f507303fc38522c6a4d1abf62e2ddc7af0f20d15b6baeb0  stroom_core_test-v6.0-beta.28-9.tar.gz/' )
...
main() {
  ...
  local -r stack_tag="stroom-stacks-v6.1-beta.8"
  local -r stack_version="v6.1-beta.8"
  local -r hash_file_contents="2c0fd2d4da61b640ca2f0abb9e1085830370e7380546c1b1afc4933a63c931fb  stroom_core_test-v6.1-beta.8.tar.gz"
